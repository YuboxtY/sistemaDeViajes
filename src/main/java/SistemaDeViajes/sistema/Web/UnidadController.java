...
public class UnidadController {
    ...
    public String editarUnidad(Unidad unidad, Model modelo) {
        ...
        return "agregar"; // Redirige a la vista de agregar para editar
    }
    ...
    public String guardarUnidad(Unidad unidad, Errors errores) {
        ...
        return "redirect:/list"; // Redirige a la lista de unidades después de guardar
    ...
    public String eliminarUnidad(Unidad unidad) {
        ...
        return "redirect:/list"; // Redirige a la lista de unidades después de eliminar
    }
